...
from homepage.inventory_version import get_olv, get_clothesbar, get_nowsaigon, get_hades, get_dirtycoins,  \
    ...
    get_heyyoustudio, get_errorist, get_fusionism, get_shebyshj, get_cecicela, get_lepoulet
...
def update_homepage():
    ...
    home_page_list = [get_olv, get_lepoulet, ]
    # home_page_list += [get_clothesbar, get_nowsaigon, get_hades, get_dirtycoins,
    #               get_degrey, get_libeworkshop, get_swe, get_blvck, get_tsun, get_tatichubeyoung, get_edini,
