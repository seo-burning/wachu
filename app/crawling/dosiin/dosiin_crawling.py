...
def get_product_sub_list(obj, products_soup, category_obj, sub_cat_obj, duplicate_check_list):
    product_list = []
...
def get_dosiin():
    ...
    category_list = [
        'top',
        # 'outer',
        # 'bottom', 'bag', 'sneaker', 'headwear', 'acc', 'nu', 'nam'
    ]
    sub_category = {'top': ['sleeveless', 'short-sleeve', 'long-sleeve', 'long-sleeve-vi', 'hoodie-hood-zipup', 'shirts-blouses', 'pike-polo', 'ao-thun-basic', ],
                    'outer': ['anorak', 'jacket', 'training-track-suit', 'denim-vi', 'leather-rider', 'windbreaker', 'jumper', 'ao-blazer'],
                    'bottom': ['denim-vi-2', 'short-pants', 'cotton-pants', 'suit-pants-slacks', 'training-jogger-pants', 'skirt', 'leggings', 'yem-dungarees', 'quan-lot'],
                    'bag': ['messenger-cross', 'wallet', 'clutch-pouch', 'backpack', 'shoulder-tote', 'double-boston', 'waist'],
                    'sneaker': ['sneakers', ], 'headwear': ['cap', 'beanie', 'beanie-vi', 'beanie-vi-2', 'others-vi-2'],
                    'acc': [], 'nu': [], 'nam': []}
    product_list = []
        ...
        for sub_cat_obj in sub_category[category_obj]:
            ...
            while True:
                ...
                product_sub_list, duplicate_check_list = get_product_sub_list(
                    obj, products_source, category_obj, sub_cat_obj, duplicate_check_list)
