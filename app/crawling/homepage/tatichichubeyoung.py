...
def sub_crawler(obj, product_source):
    ...
    for product_obj in product_source:
        ...
        product_link = "https://tatichu.com"+product_link_soup.get('href')
        print(product_link)
...
def get_tatichichubeyoung():
    print('operating tachichubeyoung crawler')
    obj = HomepageCrawler()
    i = 1
    product_list = []
    while True:
        url = "https://tatichu.com/collections/all?page=" + str(i)
