...
def sub_crawler(obj, product_source, url_obj, duplicate_check_list):
    ...
    for product_obj in product_source:
        ...
        product_link = "http://edini.vn"+product_link_soup.get('href')
        print(product_link)
...
def get_edini():
    print('operating edini crawler')
    obj = HomepageCrawler()
    url_list = [
        'dress',
        'skirt', 't-shirts', 'blouse', 'jeans-pants', 'shorts',
        'giay']
    product_list = []
    ...
    for url_obj in url_list:
        i = 1
        while True:
            url = "http://edini.vn/collections/"+url_obj+"?page=" + str(i)
