...
def sub_crawler(obj, product_source):
    ...
    #     product size
        product_size_color_options = product_soup.find_all('div', class_='header')

        shopee_size_list = []
        shopee_color_list = []
        for product_size_option in product_size_color_options:
            if product_size_option:
                if product_size_option.text == "Kích thước:":
                    product_size_list = product_size_option.parent.find_all('div', class_='n-sd')
                ...
                elif product_size_option.text == "Tiêu đề:" or "Màu sắc:":
                    product_color_list = product_size_option.parent.find_all('div', class_='n-sd')
                    ...
                    print("this is awkward" + product_size_color_options.text)
                    break
