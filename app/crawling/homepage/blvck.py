...
def sub_crawler(obj, product_source, url_obj, duplicate_check_list):
    ...
    for product_obj in product_source:
        ...
        product_link = "http://blvck-clothing.com"+product_link_soup.get('href')
        print(product_link)
...
def get_blvck():
    ...
    for url_obj in url_list:
        i = 1
        while True:
            url = "https://blvck-clothing.com/collections/"+url_obj+"?page=" + str(i)
